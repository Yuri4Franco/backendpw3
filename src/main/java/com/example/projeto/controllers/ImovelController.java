...
import com.example.projeto.dtos.ImovelDTOExibe;
...
public class ImovelController {
	...
	@RequestMapping(method = RequestMethod.GET)
	public ResponseEntity<List<ImovelDTOExibe>> getAll() {
		List<ImovelModel> list = service.getAll();
	
		List<ImovelDTOExibe> listaDtos = list.stream().map(imovel -> new ImovelDTOExibe(imovel))
